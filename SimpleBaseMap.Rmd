...
Sometimes we need to put points on a simple map that shows the geographic location of sampling points, stations, or species for which we know the geographic coordinates. This script allows you to easily view points by creating a data frame of locations.
